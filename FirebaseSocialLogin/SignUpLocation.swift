    ...
    func handleTap(gestureReconizer: UILongPressGestureRecognizer) {
        ...
        alert.addAction(UIAlertAction(title: "Continue", style: UIAlertActionStyle.default, handler: { action in
            ...
            if UserDefaults.standard.string(forKey: "UserType") == "Hospital" {
                url = "http://staging.techeasesol.com/calllight/public/api/v1/profile/hospitals?api_token="+UserDefaults.standard.string(forKey: "apiToken")!
            } else {
                url = "http://staging.techeasesol.com/calllight/public/api/v1/profile/hospitals?api_token="+UserDefaults.standard.string(forKey: "apiToken")!
            }
            ...
            Alamofire.request(completeUrl, method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers ).responseJSON{ response in
                ...
                case .success:
                    ...
                    if let value = response.result.value {
                        ...
                        if UserDefaults.standard.string(forKey: "UserType")! == "Nurse" && UserDefaults.standard.string(forKey: "profileComplete") == "0" {
